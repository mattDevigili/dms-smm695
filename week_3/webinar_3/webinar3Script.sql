...
\copy artworks(id, accession_number, artist, artistRole, artistId, title, dateText, medium, creditLine, year, acquisitionYear, dimensions, width, height, depth, units, inscription, thumbnailCopyright, thumbnailUrl, url) FROM '/Users/matteo/Desktop/artwork_data.csv' DELIMITER ',' CSV HEADER;
...
-- Split last_name and first_name
ALTER TABLE artists 
...
CREATE INDEX idx_accession_number ON artworks_id(accession_number);

-- It depends on what is your scope
