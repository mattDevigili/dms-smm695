...
/* The _1.csv contains 112 observations from tate data, that we will import
into PostgreSQL and then we will work with them. For this tutorial I'm
working within psql (you can replicate everything within pgAdmin4). */
...
\copy table_array(gender, mda, movNames) FROM '/PATH/TO/YOUR/_1.csv' CSV HEADER DELIMITER';';
